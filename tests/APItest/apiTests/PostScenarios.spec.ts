...
test.describe('Restful API - User Creation', () => {
    
    test('MacBook Pro başarıyla oluşturulabilmeli', async ({ request }) => {
        ...
        const response = await objectController.createUser(newUser);
